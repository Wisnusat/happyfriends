                  ...
                  <div className="absolute bottom-4 left-1/2 transform -translate-x-1/2 flex space-x-2">
                    {images.map((_, index) => (
                      <button
                        ...
                        className={`w-2 h-2 rounded-full transition-all duration-300 ${index === currentIndex ? "bg-white shadow-lg scale-125" : "bg-white/60 hover:bg-white/80"
                          }`}
                      />
                    ))}
                  </div>
      ...
      <div className="flex justify-center mt-3 space-x-2">
        {images.map((_, index) => (
          <button
            ...
            className={`w-2 h-2 rounded-full transition-all duration-300 ${index === currentIndex ? "bg-white shadow-lg scale-110" : "bg-white/50 hover:bg-white/70"
              }`}
          />
        ))}
      </div>
        ...
        <div className="absolute bottom-2 left-1/2 transform -translate-x-1/2 flex space-x-1">
          {images.map((_, index) => (
            <button
              key={index}
              onClick={() => goToSlide(index)}
              className={`w-1.5 h-1.5 rounded-full transition-all duration-300 ${index === currentIndex ? "bg-white shadow-lg scale-110" : "bg-white/50 hover:bg-white/70"
                }`}
            />
          ))}
        </div>
...
export default function HomePage() {
  ...
  const videoImages = ["/v1.mp4", "/placeholder.mp4", "/placeholder.mp4"]
  ...
  // Client logos - using placeholder for now, you can replace with actual client logos
  const clientLogos = [
    "/placeholder.svg?height=80&width=80&text=Client+1",
    "/placeholder.svg?height=80&width=80&text=Client+2",
    "/placeholder.svg?height=80&width=80&text=Client+3",
    "/placeholder.svg?height=80&width=80&text=Client+4",
    "/placeholder.svg?height=80&width=80&text=Client+5",
    "/placeholder.svg?height=80&width=80&text=Client+6",
    "/placeholder.svg?height=80&width=80&text=Client+7",
    "/placeholder.svg?height=80&width=80&text=Client+8",
    "/placeholder.svg?height=80&width=80&text=Client+9",
    "/placeholder.svg?height=80&width=80&text=Client+10",
    "/placeholder.svg?height=80&width=80&text=Client+11",
    "/placeholder.svg?height=80&width=80&text=Client+12",
    "/placeholder.svg?height=80&width=80&text=Client+13",
    "/placeholder.svg?height=80&width=80&text=Client+14",
    "/placeholder.svg?height=80&width=80&text=Client+15",
    "/placeholder.svg?height=80&width=80&text=Client+16",
    "/placeholder.svg?height=80&width=80&text=Client+17",
    "/placeholder.svg?height=80&width=80&text=Client+18",
    "/placeholder.svg?height=80&width=80&text=Client+19",
    "/placeholder.svg?height=80&width=80&text=Client+20",
  ]
    ...
    <div className="min-h-screen bg-white text-gray-900 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="bg-gradient-to-br from-orange-500 to-red-500 rounded-3xl p-8 border-4 border-black shadow-2xl">
              <h3 className="text-4xl font-black text-white mb-2">Yearbook Design</h3>
            ...
            <div className="bg-gradient-to-br from-purple-600 to-indigo-600 rounded-3xl p-8 border-4 border-black shadow-2xl">
              <h3 className="text-4xl font-black text-yellow-300 mb-2">Photography</h3>
              <p className="text-white text-lg mb-8 font-bold">Capturing moments that last forever</p>
            ...
            <div className="bg-gradient-to-br from-gray-800 to-black rounded-3xl p-8 border-4 border-black shadow-2xl">
              <h3 className="text-4xl font-black text-red-400 mb-2">Video</h3>
              ...
              <div className="bg-white/10 rounded-2xl p-4 mb-8 border-4 border-white">
                ...
                >
                  ...
                  {/* <div className="absolute bottom-4 left-4 bg-black/70 rounded-lg px-3 py-1">
                    <span className="text-white font-bold text-sm">Video Production 1</span>
                  </div> */}
                </div>
              </div>
          ...
          <div className="bg-gradient-to-br from-purple-100 via-pink-50 to-orange-100 rounded-3xl p-8 border-4 border-purple-200 shadow-2xl overflow-hidden">
            <div className="relative">
              ...
              <div className="flex animate-scroll-right mb-6">
                {[...clientLogos.slice(0, 10), ...clientLogos.slice(0, 10)].map((logo, index) => (
                  <div
                    key={index}
              ...
              <div className="flex animate-scroll-left">
                {[...clientLogos.slice(10, 20), ...clientLogos.slice(10, 20)].map((logo, index) => (
                  <div
                    key={index}
      ...
      <section id="contact" className="relative z-10 px-4 py-20 bg-gray-50">
        <div className="max-w-2xl mx-auto">
          {" "}
          {/* Changed from max-w-4xl to max-w-2xl for narrower width */}
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-6xl font-black mb-4 bg-gradient-to-r from-pink-500 to-purple-500 bg-clip-text text-transparent">
              Contact Our Admin
            </h2>
          ...
          {/* Contact Card - Centered and narrower */}
          <div className="bg-white rounded-3xl p-8 shadow-2xl border-2 border-gray-200 mb-8 max-w-md mx-auto">
            {/* Logo and Title */}
            <div className="text-center mb-8">
              <div className="w-20 h-20 bg-gradient-to-r from-pink-500 to-purple-500 rounded-full flex items-center justify-center mx-auto mb-4">
                <span className="text-white font-black text-2xl">HFP</span>
              </div>
              <h3 className="text-2xl font-black text-gray-800 mb-2">Happy Friends Project</h3>
              <p className="text-purple-500 font-bold">Admin Pusat</p>
            </div>
            ...
            <div className="space-y-4">
              ...
              <div className="bg-purple-100 rounded-2xl p-4">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    <h4 className="font-black text-gray-800">WhatsApp</h4>
                    <p className="text-purple-600 font-bold">+62 811-1224-478</p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-orange-100 rounded-2xl p-4">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    <h4 className="font-black text-gray-800">Telepon</h4>
                    <p className="text-orange-600 font-bold">+62 811-1224-478</p>
                  </div>
                </div>
              </div>
            </div>
          </div>
          {/* Need Quick Response Section - Updated gradient */}
          <div className="bg-gradient-to-r from-pink-500 via-purple-500 to-cyan-400 rounded-3xl p-8 shadow-2xl border-4 border-gray-900 mb-8">
            <div className="text-center">
              <h3 className="text-3xl font-black text-white mb-4">Need Quick Response?</h3>
              <p className="text-white/90 text-lg mb-6 font-bold">Chat langsung dengan admin kami!</p>

              <Button
                onClick={openWhatsApp}
                className="bg-white hover:bg-gray-100 text-black px-8 py-4 text-lg font-black rounded-full shadow-xl border-2 border-white transform hover:scale-105 transition-all"
              >
      ...
      <footer className="relative py-6">
        <div className="max-w-7xl mx-auto px-4">
          <div className="flex flex-col items-center justify-center text-center space-y-2">
            <h3 className="text-xl font-black bg-gradient-to-r from-purple-600 to-pink-600 bg-clip-text text-transparent">HAPPY FRIENDS PROJECT</h3>
            <p className="bg-gradient-to-r from-purple-600 to-pink-600 bg-clip-text text-transparent font-bold text-base">#BEHAPPYWITHYOURFRIENDS</p>
            <div className="flex justify-center space-x-6 py-6">
              ...
              <a
                ...
                className="w-8 h-8 bg-gradient-to-r from-pink-500 to-purple-500 rounded-full flex items-center justify-center hover:scale-110 transition-transform shadow-lg"
              >
              ...
              {/* TikTok */}
              <a
                href="https://www.tiktok.com/search?q=happy%20friends%20project&t=1751446942955"
                target="_blank"
                rel="noopener noreferrer"
                className="w-8 h-8 bg-gradient-to-r from-gray-800 to-black rounded-full flex items-center justify-center hover:scale-110 transition-transform shadow-lg"
              >
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="w-8 h-8 bg-gradient-to-r from-red-500 to-red-600 rounded-full flex items-center justify-center hover:scale-110 transition-transform shadow-lg"
              >
                <svg className="w-4 h-4 text-white" fill="currentColor" viewBox="0 0 24 24">
            ...
            <p className="text-gray-400 text-xs">© 2025 Happy Friends Project. All rights reserved.</p>
            <p className="text-gray-400 text-xs">Created By B²AN</p>
          </div>
        </div>
      </footer>
